...
static STowerData TowerData1("TOWER_NAME_1", 10, 4, 200, 100, ETowerType::E_TOWER_ATTACK, 1, 1);
static SEnemyData EnemyData1("ENEMY_NAME_1", 50, 50, 20, 2, 2);
static SObstacleData ObstacleData1("OBSTACLE_NAME_1", 3, 3);
static SBulletData BulletData1("BULLET_NAME_1", 200, 10, 4, 4);
...
static SMapData MapData1("MAP_NAME_1", 10, 10, LogicPosition(0,0), LogicPosition(9,9), 5, 100, 5, Wave, 0, 0);
