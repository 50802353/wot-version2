...
#include "Header.h"
#include "CVSView.h"
#include "CAndroidView.h"	//Modified: Add when create CAndroidView
...
namespace GameTutor
{
	...
	{
		friend class CSingleton<CViewController<View> >;
	public:
		static void CreateView(int width, int height,  bool fullscreen = false, const char*name = 0)
		{
			CSingleton<CViewController<View> >::GetInstance()->m_pView = new View(width, height, fullscreen, name);
