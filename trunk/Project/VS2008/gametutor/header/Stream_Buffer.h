...
public:
	...
	void Init(__UINT8* input, __UINT32 size, bool CloneBuffer)
	{
	...
	bool IsEndOfStream()
	{
		__UINT32 cur = reinterpret_cast<__UINT32>(m_pBufferPointer);
		__UINT32 end = reinterpret_cast<__UINT32>(m_pBuffer + m_iBufferLength);
		return (cur >= end);
	}
	...
	{
		__UINT32 cur = reinterpret_cast<__UINT32>(m_pBufferPointer);
		__UINT32 begin = reinterpret_cast<__UINT32>(m_pBuffer);
		return cur - begin;
	}
